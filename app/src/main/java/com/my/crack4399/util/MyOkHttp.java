...
public class MyOkHttp {
    ...
    public <T> void submitFormdata(@NotNull String url, @NotNull ArrayMap<String, String> params, @NotNull final OkHttpCallBack<T> okHttpCallBack, @NotNull final Class<T> clazz) {
        ...
        final Request request = new Request.Builder()
                .addHeader("User-Agent", "4399GameCenter/5.3.1.45(android;iPhone 8;46.4.4;1080x1776;WIFI;1395.434;baidu)")
                .addHeader("mareacode", "999999")
                .addHeader("m-id", "8C%3A3A%3AE3%3A19%3ABC%3AFE")
                .addHeader("mudid", "1103gqVB80oYWEzCK5IJk00ac")
                .addHeader("SM-DEVICEID", "202006011649148b97a252ee4d99bded8b0f27277cfadd019240bc0cb188a4")
                .addHeader("mdeviceId", "359250050014594")
                .url(url)
                .post(body)
                .build();
